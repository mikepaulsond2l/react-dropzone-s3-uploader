...
var DropzoneS3Uploader = (function (_React$Component) {
  ...
  function DropzoneS3Uploader() {
    ...
    this.onProgress = function (progress, textState, file) {
    ...
    this.onFinish = function (info, file) {
      var filenames = _this.state.filenames || [];
      var filename = file.name;
      filenames.push(filename);
      var newState = { filename: filename, filenames: filenames, error: null, progress: null };
      _this.setState(newState, function () {
        return _this.props.onFinish && _this.props.onFinish(info, file);
      });
    };
    ...
    this.handleDrop = function (files, rejectedFiles) {
      ...
      var options = Object.assign({
        ...
        signingUrlQueryParams: _this.props.signingUrlQueryParams,
        signingUrlHeaders: _this.props.signingUrlHeaders,

        uploadRequestHeaders: _this.props.headers || _this.props.uploadRequestHeaders,
        contentDisposition: _this.props.contentDisposition,
  ...
  _createClass(DropzoneS3Uploader, null, [{
    ...
    value: {
      ...
      signingUrlQueryParams: _react.PropTypes.oneOfType([_react.PropTypes.object, _react.PropTypes.func]),
      signingUrlHeaders: _react.PropTypes.object,
      uploaderOptions: _react.PropTypes.object,
